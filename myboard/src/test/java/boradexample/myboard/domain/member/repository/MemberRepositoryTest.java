...
import boradexample.myboard.domain.member.Role;
...
class MemberRepositoryTest {
    ...
    public void 회원저장_성공() throws Exception {
        //given
        Member member = MemberRepository.builder().username("username").password("1234567890").name("Member1").nickName("NickName1").role(Role.USER).age(22).build();
